...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-white border-r border-border shrink-0">
      {/* Brand */}
      ...
      <div className="px-4 py-3">
        <span className={cn('inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold', role ? roleColors[role] : 'bg-muted text-muted-foreground')}>
